...
namespace GRB
{
	Greibach greibach(NS('S'), TS('$'), 6,
		Rule(NS('S'), GRB_ERROR_SERIES, 2,   //  —труктура программы
		...
		Rule(NS('N'), GRB_ERROR_SERIES + 2, 8,  // возможные конструкции в ф-и€х
		...
		Rule(NS('E'), GRB_ERROR_SERIES + 3, 13, // выражени€
			Rule::Chain(1, TS('i')),
			Rule::Chain(1, TS('l')),
		...
		Rule(NS('M'), GRB_ERROR_SERIES + 5, 8, // знаки
